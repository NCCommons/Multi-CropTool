    ...
    $login_logout_lis = <<<HTML
        <li class="nav-item col col-lg-auto dropdown">
            <div id="user_login" class="navbar-text">
                <a href="https://nccroptool.toolforge.org/api/auth/login"><i class="fas fa-sign-in-alt fa-sm fa-fw mr-2"></i> Login</a>
            </div>
        </li>
        <li class="nav-item col col-lg-auto dropdown">
        ...
        <li class="nav-item col col-lg-auto dropdown">
            <div id="user_logout" class="navbar-text" style="display:none">
                <span> </span> <a href="https://nccroptool.toolforge.org/api/auth/logout"> <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2"></i></a>
            </div>
        </li>
    HTML;
    // ---
